...
| :---: | :--- | :---: | :---: | :--- |
| **⚡** | [`set_all_passwords_to_1234567.sql`](file:///s:/College%20journey/COLLEGE%20THINGS/Jaypee%20School%20Connect/code/dummy%20data/set_all_passwords_to_1234567.sql) | **Standalone Reset** | **Instant Script** | One-click script in Supabase SQL Editor setting the password of all existing users in `auth.users` to `1234567`. |
| **00** | [`00_auth_users_and_passwords.sql`](file:///s:/College%20journey/COLLEGE%20THINGS/Jaypee%20School%20Connect/code/dummy%20data/00_auth_users_and_passwords.sql) | **2,735 Auth Accounts** | **2,735 Auth Accounts** | Creates `auth.users` and `auth.identities` records for 112 Principals, 493 Teachers, and 2,130 Students with universal password `1234567` and confirmed emails. |
...
| **Master** | [`master_seed.sql`](file:///s:/College%20journey/COLLEGE%20THINGS/Jaypee%20School%20Connect/code/dummy%20data/master_seed.sql) | **All Datasets** | **3.2 MB Unified SQL** | Chronological single-transaction execution file running 00 through 07 in one block (`BEGIN ... COMMIT;`). |
